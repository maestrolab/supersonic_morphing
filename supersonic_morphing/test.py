...
X, Z, Y = data['COORD']['Step-2'][0].T
U1, U3, U2 = data['U']['Step-2'][0].T
Z = -Z
U3 = -U3
...
for step in steps:
    loudness[step] = []
    for i in range(8): #range(len(data['COORD'][step])):
...
f = open('../data/loudness/loudness_small_simple_test4.p', 'wb')
...
with open('../data/images/3Dpicture_test4.p', 'wb') as fid:
